...
$CSVFolder = "c:\temp\CheckInactiveUserExport.csv"
...
Function OfficeUsers()
{
    ...
    $SearchName = $Mailbox.UserPrincipalName
    $ADGroup = Get-ADUser -Filter{ UserPrincipalName -eq "$SearchName"} | Select -Property Description
