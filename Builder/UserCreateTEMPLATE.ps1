...
$ADServer = "TEMPLATE_ADSERVER" #\\ActiveDirectory-SERVER
$FileServer = "TEMPLATE_FILESERVER"
$DC = "DC=DOMAIN, DC=be"
$Domain = "TEMPLATE_DOMAIN"
$MainGroup = "TEMPLATE_MAINGROUP"
$Group = "TEMPLATE_GROUP"
$Moderator= "TEMPLATE_MODERATOR"

$year = (Get-Date).year + 1
$dbgr = "TEMPLATE_DBGROUP"
$dbPrimeGroup = "TEMPLATE_DBPRIMEGROUP"

$MainFolder= "TEMPLATE_MAINFOLDER"
$CSVFolder = "c:\temp\userexport.csv"
$SharedFolder = "TEMPLATE_SHAREDFOLDER"

# Creates groups
Function CreateGroups()
{
  # Variables for later use
  $DatabaseName = 'TEMPLATE_DATABASE.accdb'
  $GetClassesQuery = "SELECT distinct $dbgr FROM $dbPrimeGroup;"
