...
Function NetmappingPSDriveUNTISFolder{
$Username = $env:USERNAME
New-PSDrive -Name "L" -Root "\\fs-Personeel\adm\UNTIS" -Persist -Scope global -PSProvider "FileSystem" 
}
